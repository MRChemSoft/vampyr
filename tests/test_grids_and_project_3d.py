...
def test_BuildProjectSemiPeriodicGauss():
    ...
    periodic_world = vp.D3.BoundingBox(scaling=sfac, pbc=True)
    pbc = vp.D3.MultiResolutionAnalysis(box=periodic_world, basis=interpol)

    tree_1 = vp.D3.FunctionTree(pbc)
    vp.build_grid(out=tree_1, inp=gauss)
