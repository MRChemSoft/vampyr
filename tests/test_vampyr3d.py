...
H = vp.vampyr3d.HelmholtzOperator(MRA, mu, prec)
P = vp.vampyr3d.PoissonOperator(MRA, prec)

phi_tree = vp.vampyr3d.FunctionTree(MRA)
phi_tree_pois = vp.vampyr3d.FunctionTree(MRA)
v_tree = vp.vampyr3d.FunctionTree(MRA)
v_generator(v_tree, MRA, prec, beta, mid, mu)
v_tree_pois = vp.vampyr3d.FunctionTree(MRA)
