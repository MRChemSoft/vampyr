...
void trees(py::module &m) {
   ...
   // py::class_<FunctionNode<D>> funcnode(m, "FunctionNode", mwnode);
   // funcnode.def(py::init<MWNode<D>>());
   ...
   // py::class_<OperatorNode>(m, "OperatorNode", mwnode)
   //     .def(py::init<MWNode<2>>());


    py::class_<OperatorTree>(m, "OperatorNode", mwtree)
